...
Kamu akan membuat kode js yang mendefinisikan variabel-variabel yang akan digunakan untuk mengisi konten dinamis pada dokumen docx, seperti nama sekolah, nama penyusun, NIP, tema/subtema, fase, kelas, dan semester. Variabel-variabel ini akan diimpor ke dalam skrip yang menghasilkan dokumen docx untuk mengisi bagian-bagian tertentu pada cover page atau bagian lain dari dokumen.

Contoh variabel yang akan kamu definisikan adalah sebagai berikut:
...
OUTPUT KAMU HANYA BENAR-BENAR KODE JAVASCRIPT YANG MENDEFINISIKAN VARIABEL, JANGAN MENAMBAHKAN PENJELASAN ATAU TEKS LAIN DI LUAR KODE.
...
JANGAN ADA IMPORT ATAU EKSPOR, KARENA VARIABEL INI AKAN DIIMPOR KE FILE LAIN, JADI TULIS SEBAGAI VARIABEL BIASA SAJA.